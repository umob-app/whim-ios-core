...
/// and it fits well to our Whim Scene Navigation, as it highly relies on autolayout as well.
...
///
/// When using it within Whim Scene, which might consist of top and bottom controllers,
