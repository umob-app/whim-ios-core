...
/// A view-controller that presents required view-controller within whim flow,
...
open class WhimSceneContainerViewController: UIViewController, WhimScene {
    public private(set) var rootScene: WhimScene

    public let presentedSceneViewController: ObservableProperty<WhimSceneViewController?>
    private let presentedSceneViewControllerRelay: BehaviorRelay<WhimSceneViewController?>
    ...
    @discardableResult
    public final func set(root: WhimScene, animating: WhimSceneAnimatedTransitioning? = nil) -> Bool {
    ...
    public final func present(scene: WhimScene, animating: WhimSceneAnimatedTransitioning?) {
        ...
        transition(
            ...
            animating: animating ?? WhimSceneAnimatedTransitions.None()
        )
    }

    private func prepareBeforeTransition(_ viewController: WhimSceneViewController) {
    ...
    private func transition(from: WhimSceneViewController?, to: WhimSceneViewController, animating: WhimSceneAnimatedTransitioning) {
