...
public protocol WhimScenePresentation: AnyObject {
...
public extension WhimScenePresentation {
    func dispatch(_ action: Action) {
        output?(action)
    }
}

/// Any UIViewController with `WhimScenePresentation` interface.
public typealias WhimScenePresentationViewController = UIViewController & WhimScenePresentation
