...
public extension WhimSceneStore {
    /// A helper method to connect `WhimSceneStore` with fullscreen `WhimScenePresentation`.
    ///
    ...
    func bind<R: WhimScenePresentationViewController>(
        fullscreen: WhimSceneBinding<Self, R>,
...
public extension WhimSceneStore {
    /// A helper method to connect `WhimSceneStore` with multipart `WhimScenePresentation`.
    ///
    ...
    func bind<T: WhimScenePresentationViewController, B: WhimScenePresentationViewController, M: WhimScenePresentation>(
        top: WhimSceneBinding<Self, T>,
        bottom: WhimSceneBinding<Self, B>,
        map: WhimSceneBinding<Self, M>,
        router: @escaping (Route) -> Void
    ) {
...
public extension WhimSceneStore where Route == Never {
    func bind<P: WhimScenePresentationViewController>(fullscreen: WhimSceneBinding<Self, P>) {
...
public struct WhimSceneBinding<S: WhimSceneStore, P: WhimScenePresentation> {
...
public extension WhimSceneBinding {
    /// You might need this in case you don't want any presentation (i.e. Map).
    static var none: WhimSceneBinding<S, NonePresentation> {
        WhimSceneBinding<S, NonePresentation>(presentation: NonePresentation(), state: { _ in nil }, action: { _ in nil })
    }
}

public final class NonePresentation: WhimScenePresentation {
